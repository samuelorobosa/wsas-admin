...
import './ShippingRequestTable.css';
import { FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { IconContext } from 'react-icons';
import { useState } from 'react';
import {useWindowSize} from "../../../../../../core/hooks/index.js";

export default function ShippingRequestTable ({ orders }) {
  const { isMobile } = useWindowSize();

  return isMobile ? (
    <ShippingRequestTable.Mobile orders={orders} />
  ) : (
    <ShippingRequestTable.Desktop orders={orders} />
  )
}

ShippingRequestTable.Mobile = ({ orders }) => {
  return (
...
ShippingRequestTable.Desktop = ({ orders }) => {
